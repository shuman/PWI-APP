 ...
 */
	...
	$(".overlay-cause-item").on({
		mouseenter: function mouseenter() {
			...
			$icon.addClass(iconClass.replace("-stroke", "-solid")).removeClass(iconClass).css('color', '#f1657f');
		...
		mouseleave: function mouseleave() {
			...
			$icon.addClass(iconClass.replace("-solid", "-stroke")).removeClass(iconClass).css('color', '#33aef4');
	...
	$(".overlay-subcause-list").each(function () {
		...
		if ($(this).find(".sub-cause-list a").length < 4) {
			...
			$(this).find(".sub-cause-list a").each(function () {
				...
				$(this).parent().removeClass("col-lg-3 col-md-3 col-sm-3");

				if (size == 1) {
					$(this).parent().addClass("col-lg-12 col-md-12 col-sm-12");
				} else if (size == 2) {
					$(this).parent().addClass("col-lg-6 col-md-6 col-sm-6");
				} else if (size == 3) {
					$(this).parent().addClass("col-lg-4 col-md-4 col-sm-4");
				}
			});
		}
	});
	...
	$(".navbar-toggle").on("click", function () {
		...
		if ($(".mobile-pull-down-menu").hasClass("down")) {
			...
			if ($("nav.std-navbar").length > 0) {
				$(".navbar-toggle").css("background-color", "#f1f1f1").find(".icon-bar").css("background-color", "#888");
			} else {
				$(".navbar-toggle").css("background-color", "#fff").find(".icon-bar").css("background-color", "#888");
			}
   ...
   $(".mobile-pull-down-menu").animate({top: "-99999999px"}, "slow", function( ){
   	...
   	$(this).removeClass('down');
				...
				$(".mobile-pull-down-menu").find(".mobile-menu-item").slideDown("fast", function () {
					...
					$(".navbar-toggle").css("background-color", "#33aef4").find(".icon-bar").css("background-color", "#fff");
					...
					if (data.length > 0) {
						...
						if ($(".selective-search").hasClass("in")) {
							...
							el.popover({
								...
								html: true,
								trigger: 'manual',
								template: '<div class="popover selective-search" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>' }).popover('show');
						}
 ...
 */
	...
	function buildOrgs(data) {
		...
		for (var x in data) {
			...
			if (_typeof(data[x].org_desc) != "object") {
...
},{"bootstrap-sass":1,"jquery":4,"jquery-colorbox":2,"jquery-ui":3}]},{},[5]);
